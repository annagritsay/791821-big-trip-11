...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'flatpickr/dist/flatpickr.min.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class EventEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _applyFlatpickr() {
    ...
    if (this._isDateShowing) {
      const dateElement = this.getElement().querySelector(`.day__date`);
      this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(dateElement, {
        altInput: true,
        allowInput: true,
...
/*!*********************************!*\
  !*** ./src/components/mocks.js ***!
  \*********************************/
/*! exports provided: generatePoint, generatePoints, points, menuItems, filters */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class PointComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    super();
  ...
  return (
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      ...
      <div class="trip-sort__item  trip-sort__item--event">
        <input data-sort-type="${SortType.EVENT}" id="${SortType.EVENT}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-event" checked>
        <label class="trip-sort__btn" for="sort-event">Event</label>
      </div>

      <div class="trip-sort__item  trip-sort__item--time">
        <input data-sort-type="${SortType.TIME}" id="${SortType.TIME}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time">
      ...
      <div class="trip-sort__item  trip-sort__item--price">
        <input data-sort-type="${SortType.PRICE}" id="${SortType.PRICE}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price">
...
/* harmony import */ var _components_content_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/content.js */ "./src/components/content.js");
/* harmony import */ var _components_group_days_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/group-days.js */ "./src/components/group-days.js");
...
/* harmony import */ var _components_nopoints_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/nopoints.js */ "./src/components/nopoints.js");
/* harmony import */ var _point_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./point.js */ "./src/controllers/point.js");
...
const renderPoints = (taskListElement, data, onDataChange, onViewChange) => {
  return data.map((item) => {
    const taskController = new _point_js__WEBPACK_IMPORTED_MODULE_5__["default"](taskListElement, onDataChange, onViewChange);
...
const getSortedPoints = (data, sortType, from, to) => {
  ...
  switch (sortType) {
    ...
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].PRICE:
      ...
      break;
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT:
...
class ContentController {
  constructor(container) {
    ...
    this._noPointsComponent = new _components_nopoints_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._Content = new _components_content_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._GroupDays = new _components_group_days_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._Day = new _components_day_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._NoPoints = new _components_nopoints_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  ...
  render(data) {
    ...
    if (data.length === 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(container, this._NoPoints, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);

      return;
    }
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(container, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(container, this._Content, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);

    const tripDays = document.querySelector(`.trip-days`);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(tripDays, this._GroupDays, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);

    const day = document.querySelector(`.day`);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(day, this._Day, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
...
/* harmony import */ var _components_points_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/points.js */ "./src/components/points.js");
...
class PointController {
  ...
  render(point) {
    ...
    this._pointComponent = new _components_points_js__WEBPACK_IMPORTED_MODULE_0__["default"](point);
    this._pointEventEditComponent = new _components_event_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](point);
    ...
    if (oldPointEditComponent && oldPointComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._pointComponent, oldPointComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._pointEventEditComponent, oldPointEditComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._pointComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
  }
  ...
  _replaceEditToTask() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._pointComponent, this._pointEventEditComponent);
    this._mode = Mode.DEFAULT;
  }

  _replaceTaskToEdit() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._pointEventEditComponent, this._pointComponent);
...
const Content = new _controllers_content_js__WEBPACK_IMPORTED_MODULE_5__["default"](tripEventsElement);
...
Content.render(_components_mocks_js__WEBPACK_IMPORTED_MODULE_4__["points"]);
